...
def main():
    ...
    targets = [
        ('Maps', 'OEJD/Plugins/GRPlugin/GRpluginMaps.txt', ['regions.txt', 'geo.txt', 'freetext.txt', 'nets.txt'], add_colours_and_definitions),
        ('Stands', 'OEJD/Plugins/GRPlugin/GRpluginStands.txt', ['stands.txt'], add_stand_groups),
    ]
